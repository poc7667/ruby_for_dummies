...
def to_zodiac(bday)
  ...
  zodiac_descriptions['Pisces'] = []
  zodiac_descriptions['Aries'] = []
  zodiac_descriptions['Taurus'] = []
  zodiac_descriptions['Gemini'] = []
  zodiac_descriptions['Cancer'] = []
  zodiac_descriptions['Leo'] = []
  zodiac_descriptions['Virgo'] = []
  zodiac_descriptions['Libra'] = []
  zodiac_descriptions['Scorpio'] = []
  zodiac_descriptions['Sagittarius'] = []
  zodiac_descriptions['Capricorn'] = []
